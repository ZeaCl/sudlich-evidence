# U-BORTUZAR — Acceso Benjamin Ortuzar
...
| Check | Resultado |
|---|---|
| Login OAuth2 en landing screen | ✅ |
| CraniumShell carga | ✅ |
| Sidebar MANAGEMENT (Dashboard, Fondos, LPs, Capital Calls) | ✅ |
| Página de Fondos con "+ Crear Fondo" | ✅ |
| Sidebar WORKSPACE (Workflows, Archivos, Skills) | ✅ |

## Credenciales

- **Email**: bortuzar@sudlich.cl
